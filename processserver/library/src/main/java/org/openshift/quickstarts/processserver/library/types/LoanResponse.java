...
@XmlType(name = "loanResponse", namespace = "urn:openshift-quickstarts:processserver-library:1.3", propOrder = {
    "loan"
})
@XmlRootElement(name = "loanResponse", namespace = "urn:openshift-quickstarts:processserver-library:1.3")
